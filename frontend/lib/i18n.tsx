  ...
  de: {
    ...
    runForm: {
      labels: {
        ...
        subTestCase: "SubTestCase",
        concurrency: "Concurrency",
        dnsSwitch: "Alle DNS A/AAAA Records prüfen",
        auto421Switch: "421 Misdirect automatisch überschreiben",
      ...
      applyBlacklistDescription: "Ziele überspringen, deren IP auf der Blacklist steht",
      directoriesDescription: "Datei mit Zeilen wie /admin (wird //admin), or admin (wird /admin)",
      statusFiltersDescription: "Schalter sind standardmäßig an. Deaktiviere einen Status, um passende Antworten zu verwerfen (werden nicht gespeichert).",
      statusFilterCode: "Status {{code}}",
      combinationSummary: "URLs × FQDNs × Verzeichnisse: {{urls}} × {{fqdns}} × {{directories}} = {{total}} Kombinationen",
      submit: "Run starten",
      errorTitle: "Fehler",
    },
    runsPage: {
    ...
    heatmap: {
      ...
      auto421Tooltip: "421 wurde automatisch mit Host-SNI überschrieben",
